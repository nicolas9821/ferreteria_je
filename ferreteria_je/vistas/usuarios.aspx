<%-- ferreteria_je/usuarios.aspx --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="usuarios.aspx.cs" Inherits="ferreteria_je.usuarios" %>
...
<head>
    ...
    <title>Usuarios - Administrador Ferretería</title>
    <link rel="stylesheet" href="../estilos/inicio.css">
    <link rel="stylesheet" href="../estilos/proveedores.css"> <%-- Reutilizamos el mismo CSS para la tabla --%>
        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="usuarios.aspx" class="activo">Usuarios</a></li>
        ...
        <main class="main-content">
            <form id="form1" runat="server">
                ...
                <div class="header-section">
                    ...
                    <div class="actions">
                        <asp:LinkButton ID="lnkAgregarUsuario" runat="server" CssClass="btn btn-primary" OnClick="lnkAgregarUsuario_Click">
                            Agregar Usuario
                        </asp:LinkButton>
                        ...
                        <div class="search-container">
                            <asp:TextBox ID="txtSearch" runat="server" CssClass="search-input" placeholder="Buscar usuario..." AutoPostBack="True" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
                ...
                <div class="table-container">
                    ...
                    <%-- ¡¡¡CAMBIO AQUÍ: Eliminar EnableViewState="false"!!! --%>
                    ...
                    <asp:GridView ID="gvUsuarios" runat="server" AutoGenerateColumns="False"
                        CssClass="data-table" EmptyDataText="No hay usuarios registrados." AllowPaging="True" PageSize="10"
                        OnPageIndexChanging="gvUsuarios_PageIndexChanging" OnSorting="gvUsuarios_Sorting" OnRowCommand="gvUsuarios_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="id_usuario" HeaderText="ID" Visible="False" SortExpression="id_usuario" />
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEditar" runat="server" CssClass="action-btn edit-btn" CommandName="EditarUsuario"
                                        CommandArgument='<%# Eval("id_usuario") %>'>
                                        <i class="fas fa-edit"></i>
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnEliminar" runat="server" CssClass="action-btn delete-btn"
                                        CommandName="EliminarUsuario" OnClientClick='return confirm("¿Estás seguro de que quieres eliminar este usuario?");'
                                        CommandArgument='<%# Eval("id_usuario") %>'>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            sidebarLinks.forEach(link => {
                const linkHref = link.getAttribute('href').split('/').pop().split('?')[0]; // Clean href for comparison
